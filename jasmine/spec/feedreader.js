...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
        it('each feed in the allFeeds object has a URL defined and that URL is not empty', function() {
         ...
         */
        it('each feed in the allFeeds object has a name defined and that name is not empty', function() {
            allFeeds.forEach(function(feed) {
